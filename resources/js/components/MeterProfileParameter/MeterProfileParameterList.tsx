    ...
    <div className='relative w-full rounded-lg bg-white'>
            ...
            <div className='flex items-start justify-between'>
              <div className='flex flex-1 flex-col gap-2.5 p-[10px]'>
                <div className='flex flex-col gap-1'>
                  ...
                  <div className='flex w-full items-center gap-5'>
                    <div className='flex items-center gap-[3px]'>
                      Meter Profile: <b>{meterProfileParameter.profile?.parameter_value}</b>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className='flex items-end gap-2 py-2.5 pr-2.5 pl-[15px]'>
                  <EditButton
                    onClick={() =>
                      router.get(
                        route(
                          'meter-profile-parameter.edit',
                          meterProfileParameter.meter_parameter_id
                        )
                      )
                    }
                  />
      ...
      {selectedItem && showDeleteModal && (
        <DeleteModal
          ...
          url={route('meter-profile-parameter.destroy', selectedItem.meter_parameter_id)}
        >
          <span>
