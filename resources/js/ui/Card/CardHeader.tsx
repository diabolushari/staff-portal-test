                        ...
                        {(backUrl != null || onBackClick != null) && (
                            <Tooltip>
                                <TooltipTrigger className="p-2">
                                    <BackButton link={backUrl} onClick={onBackClick} />
                                </TooltipTrigger>
                ...
                <TooltipProvider>
                    <div className="flex flex-wrap gap-2">
                        {(editUrl != null || onEditClick != null) && (
                            <Tooltip>
                                <TooltipTrigger className="p-2">
                                    <EditButton link={editUrl} onClick={onEditClick} />
                                </TooltipTrigger>
                        ...
                        {(deleteUrl != null || onDeleteClick != null) && (
                            <Tooltip>
                                <TooltipTrigger className="pr-2">
                                    <DeleteButton link={deleteUrl} onClick={onDeleteClick} />
                                </TooltipTrigger>
                        ...
                        {(existingUserUrl != null || onFolderIconClick != null) && (
                            <AddExistingUser link={existingUserUrl} onClick={onFolderIconClick} />
                        )}
                    </div>
                </TooltipProvider>
            </div>
