...
export default function ParameterDefinitionAction({ data }: { data: any }) {
    ...
    const { post, errors } = useInertiaPost(data ? route('parameter-definition.update', data.id) : route('parameter-definition.store'), {
                ...
                <div className="w-3/4 items-center justify-center rounded-xl bg-white p-8 py-8 shadow-md">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6 flex justify-between gap-4">
                            <Button type="button" variant="outline" onClick={() => window.history.back()} label="Cancel" />
