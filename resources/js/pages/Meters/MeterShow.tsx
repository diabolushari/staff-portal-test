				...
				<Card className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
					<CardContent className="p-8">
						...
						<Section title="General Information">
							...
							/>
							<InfoItem label="Make" value={meter.meter_make.parameter_value} />
							<InfoItem label="Type" value={meter.meter_type.parameter_value} />
							<InfoItem
								label="Category"
								value={meter.meter_category.parameter_value}
							/>
							<InfoItem label="Unit" value={meter.meter_unit.parameter_value} />
						</Section>
