...
import type { Meter } from "../Meters/MeterIndex";
...
export default function ConnectionsShow({
	...
	console.log(meterConnectionRel);
	...
	return (
		<MainLayout breadcrumb={breadcrumbs} navItems={connectionsNavItems}>
							...
							<Card className="rounded-lg p-7">
								<div className="mb-6 flex items-center justify-between">
									...
									<button
										onClick={() =>
											router.visit(
												route("connections.edit", connection.connection_id),
											)
										}
