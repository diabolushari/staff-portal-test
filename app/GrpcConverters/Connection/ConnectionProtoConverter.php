...
class ConnectionProtoConverter
{
    ...
    public static function convertToArray(?ConnectionMessage $connection): ?array
    {
        ...
        return [
            ...
            'created_at' => $connection->getCreatedAt() ? $connection->getCreatedAt()->toDateTime()->format('d-m-Y H:i:s') : null,
            'updated_at' => $connection->getUpdatedAt() ? $connection->getUpdatedAt()->toDateTime()->format('d-m-Y H:i:s') : null,
            ...
            'effective_start' => $connection->getEffectiveStart() ? $connection->getEffectiveStart()->toDateTime()->format('d-m-Y') : null,
            'effective_end' => $connection->getEffectiveEnd() ? $connection->getEffectiveEnd()->toDateTime()->format('d-m-Y') : null,
